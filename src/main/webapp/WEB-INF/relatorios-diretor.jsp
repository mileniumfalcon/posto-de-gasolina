...
<html lang="pt-br">
  ...
  <body>
      ...
      <form method="get" action="${pageContext.request.contextPath}/diretor/relatorios-gerente" class="needs-validation" novalidate>
            <br>
            ...
            <div class="button-group">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <td><a data-method="get" href="${pageContext.request.contextPath}/diretor/relatorios-diretor?data=atual" class="btn btn-primary mb-2" >Data Atual</a></td>
            </div>
        </form>
  </body>
