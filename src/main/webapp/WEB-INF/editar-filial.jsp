...
<html lang="pt-br">
  ...
  <header>
      <nav class="navbar navbar-light nav-color">
          <a class="navbar-brand" href="${pageContext.request.contextPath}/diretor">Postos Tades</a>
  ...
  <body>
      ...
      <ul class="nav flex-column" style="float: left;">
        ...
        <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath}/diretor/cadastrar-filial">Cadastrar Pessoa Física</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="${pageContext.request.contextPath}/diretor/cadastrar-juridico">Cadastrar Pessoa Juridica</a>
        </li>
        <li class="nav-item nav-item-last">
          <a class="nav-link" href="${pageContext.request.contextPath}/diretor/pesquisar-cliente">Pesquisar Cliente</a>
        </li>
      </ul>
        ...
        <form method="post" action="${pageContext.request.contextPath}/diretor/editar-filial" class="needs-validation" novalidate>
            ...
            <div class="button-group">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="${pageContext.request.contextPath}/filial" class="col-md-2 btn btn-lg btn-danger">Cancelar</a>
            </div>
        </form>
  </body>
